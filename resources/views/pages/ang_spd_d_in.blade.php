...
<section class="content-header">
      <h1>
        Anggaran SPD
        <small>Input Anggaran SPD Dalam Negeri</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ route('ang_plth')}}">Kontrol SPD Dalam Negeri</a></li>
        <li class="active">Input Anggaran SPD Dalam Negeri</li>
      </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Input Anggaran SPD(Dalam)</h3>
        </div>
            <form role="form">
                <div class="box-body">
