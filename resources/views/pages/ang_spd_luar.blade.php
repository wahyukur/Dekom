...
<section class="content-header">
      <h1>
        Anggaran Perjalanan Dinas Luar Negeri
        <small>Kontrol Anggaran SPD</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Kontrol Anggaran SPD (Luar)</li>
      </ol>
</section>
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <p>Penggunaan Anggaran Perjalanan Dinas Luar Negeri Tahun Periode 201...</p>
            <div class="progress">
    ...
    <div class="box">
        ...
        <!-- /.box-body -->
        <div class="box-footer">
            <a href="{{ route('ang_spd_l_in') }}" class="btn btn-primary">Input Anggaran SPD</a>
            <br>
            <p> </p>
        </div>
        <!-- /.box-footer-->
